...
I’m a **software engineer** with about 7 years of experience. For the last 3-4 years, I've done mostly frontend work with **React** and **Typescript**. I got my start in full-stack with Ruby on Rails, and I've experimented with a lot of different technologies over the years. On the side I've been working to improve my knowledge of C/C++ and Python.
...
## Fun Facts
- Before getting into coding, I worked in **biology and conservation research**. Eventually though I realized that while research and monitoring are important, what really moves the needle is technological progress. So now I am trying to do my small part in that.
- I've lived in three different places (San Diego, SF Bay Area, and Boston) and I've traveled to 20 countries, mostly in Europe. I'm hoping to expand my horizons a bit. Southeast Asia, Turkey, and Egypt are high on my list.
- I've worked in a few **coffeeshops**, and I still love a good single-origin light roast. Part of what I love about coffee is that it's an affordable luxury. Having a great coffee feels like a real treat, but it won't break the bank.
